...
const MammaryReportModal = ({ record, onClose }: MammaryReportModalProps) => {
    ...
    const handleGenerateAI = async () => {
        ...
        try {
            ...
            if (genReport) {
                setReportData({
                    aspecto_macroscopico: genReport.aspecto_macroscopico || reportData.aspecto_macroscopico,
                    microscopia: genReport.microscopia || '',
                    diagnostico: genReport.diagnostico || '',
                    nota: genReport.nota || '',
                    referencias: genReport.referencias || ''
                });
                setGenerated(true);
            }
        } catch (error) {
